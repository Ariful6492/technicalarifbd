...
body#layout #outer-wrapper,body#layout .row{
 ...
 body#layout div.header-logo,body#layout div.top-menu{
    float:none;
    width:auto;
    height:auto;
    max-width:none;
 ...
 body#layout .header-menu .row{
    display:flex
}
 body#layout #main-menu,body#layout #nav-social{
    width:50%;
    height:auto
}
 ...
 body#layout .hot-section .widget-content{
    float:none;
    width:auto;
    height:auto;
    margin:0
}
 body#layout .hot-section .widget{
    overflow:visible
}
    ...
    <div class='header-header'>    
      <div class='container row'>
        <b:section class='header-logo' id='header-logo' maxwidgets='1' name='Header Logo' showaddelement='yes'>
          <b:widget id='Header1' locked='true' title='Technical Arif BD (Header)' type='Header' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEgOscr0y7G6mpmdpjCaa3dmTLs5DpJfGQM1tgn7krl5uhKg3QlnbNirMYxGI8acdaXXGPmE8fJ8McuPyp_Zalnh2I3J8K9028bJR-lCaLqy4D1QnVOrDCBCNkwHJuww1xh0nyoyKsdXMIfswogL_tLEQw4Ol0278J8e1AE4-2j6NQrmXnkJogXwNHuw=s188</b:widget-setting>
              <b:widget-setting name='displayHeight'>36</b:widget-setting>
              <b:widget-setting name='sectionWidth'>850</b:widget-setting>
        ...
        <div id='header-search'>
          <form class='search-form' expr:action='data:blog.searchUrl' role='search'>
            ...
            <button id='search-submit' type='submit' value=''><i class='fa fa-search'/></button>
          </form>
        </div>
      </div>
    </div>
      ...
      <div class='container row'>
        ...
        <b:section class='main-menu' id='main-menu' maxwidgets='1' name='Main Menu' showaddelement='yes'>
          <b:widget id='LinkList74' locked='true' title='Link List' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='link-7'><![CDATA[https://technicalarifbd.blogspot.com/search/label/Agetel?&max-results=5]]></b:widget-setting>
              <b:widget-setting name='link-5'><![CDATA[https://technicalarifbd.blogspot.com/search/label/Mars?&max-results=5]]></b:widget-setting>
              <b:widget-setting name='link-6'>https://technicalarifbd.blogspot.com/p/frp-bypass-apk-latest-frp-bypass-2022.html</b:widget-setting>
              <b:widget-setting name='link-3'><![CDATA[https://technicalarifbd.blogspot.com/search/label/Walton?&max-results=5]]></b:widget-setting>
              <b:widget-setting name='link-4'><![CDATA[https://technicalarifbd.blogspot.com/search/label/ITEL?&max-results=5]]></b:widget-setting>
              <b:widget-setting name='text-1'>Symphony</b:widget-setting>
              <b:widget-setting name='text-0'>Home</b:widget-setting>
              <b:widget-setting name='text-3'>Walton</b:widget-setting>
              <b:widget-setting name='text-2'>Micromax</b:widget-setting>
              <b:widget-setting name='text-5'>Mars</b:widget-setting>
              <b:widget-setting name='text-4'>ITEL</b:widget-setting>
              <b:widget-setting name='text-7'>Agetel</b:widget-setting>
              <b:widget-setting name='text-6'>FRP BYPASS</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='link-1'><![CDATA[https://technicalarifbd.blogspot.com/search/label/Symphony?&max-results=5]]></b:widget-setting>
              <b:widget-setting name='link-2'><![CDATA[https://technicalarifbd.blogspot.com/search/label/Micromax?&max-results=5]]></b:widget-setting>
        ...
        <b:section class='nav-social' id='nav-social' maxwidgets='1' name='Nav Social' showaddelement='yes'>
          <b:widget id='LinkList75' locked='true' title='Social Widget' type='LinkList' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='link-3'>https://www.youtube.com/channel/UCShf3zK-T83UVYroJWsig3Q</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='text-1'>twitter</b:widget-setting>
              <b:widget-setting name='link-1'>https://twitter.com/technicalarifbd</b:widget-setting>
              <b:widget-setting name='text-0'>facebook</b:widget-setting>
              <b:widget-setting name='link-2'>https://www.instagram.com/technicalarifbd/</b:widget-setting>
              <b:widget-setting name='text-3'>youtube</b:widget-setting>
              <b:widget-setting name='link-0'>https://www.facebook.com/TechnicalArifBD/</b:widget-setting>
        ...
        <b:section class='main' id='main' maxwidgets='1' name='Main Posts' showaddelement='yes'>
          <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog' version='2' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='style.textcolor'>#1b68d1</b:widget-setting>
              <b:widget-setting name='showCommentLink'>true</b:widget-setting>
              <b:widget-setting name='style.urlcolor'>#f1ffff</b:widget-setting>
  ...
  <div class='goog-inline-block google-plus-share-container'>
    <g:plusone annotation='inline' expr:href='data:originalUrl.canonical.http' size='medium' source='blogger:blog:plusone'/>
            ...
            <b:includable id='headerByline' var='post'>
              <!-- Post Header Meta -->
                <div class='post-meta'>
                  <b:include cond='data:view.isMultipleItems' data='post' name='postCategory'/>
            ...
            <b:includable id='itemPost' var='post'>
              <!-- Item Post Content -->
              <b:tag class='post-item-content' name='div'>
      ...
      <data:platform.shareMessage/>
            ...
            <b:includable id='postAuthor' var='post'>
              ...
              <b:if cond='data:allBylineItems.author'>
                <span class='post-author'><b:if cond='data:post.author.authorPhoto.image'><img class='post-author-avatar' expr:alt='data:post.author.name' expr:src='resizeImage(data:post.author.authorPhoto.image, 20)'/></b:if><a expr:href='data:post.author.profileUrl' expr:title='data:post.author.name' target='_blank'><data:post.author.name/></a></span>
              </b:if>
            </b:includable>
            ...
            <b:includable id='postFooter' var='post'>
              ...
              <div class='post-footer'>
                <!-- Post Labels, Navigation, About Author an Related Posts -->
            ...
            <b:includable id='postLabels' var='post'>
              <b:if cond='data:view.isPost and data:allBylineItems.labels'>
  ...
  <div class='blog-pager container' id='blog-pager'>
    ...
    <b:include cond='data:view.url != data:blog.homepageUrl' name='homePageLink'/>
            ...
            <b:includable id='postReactions' var='post'>
              <!-- Post Reactions -->
              <b:if cond='data:view.isPost and data:allBylineItems.reactions'>
            ...
            <b:includable id='postShareButtons' var='post'>
              <!-- Post ShareButtons -->
              <b:if cond='data:view.isPost and data:allBylineItems.share'>
        ...
        <b:section class='sidebar common-widget' id='sidebar1' name='Sidebar Right' showaddelement='yes'>
          <b:widget id='FeaturedPost1' locked='false' title='Featured Post' type='FeaturedPost' version='2' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='postId'>3862421170057048610</b:widget-setting>
    ...
    <b:loop values='data:posts filter (p =&gt; p.id != data:view.postId)' var='post'>
      <article class='post' role='article'>
        <b:include name='snippetedPostContent'/>
          ...
          <b:widget id='HTML1' locked='false' title='Subscribe Us' type='HTML' version='2' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'>&lt;div class=&quot;youtube-player&quot; data-id=&quot;eX3rXdARikg&quot; /&gt;
&lt;style&gt;
.youtube-player {
  position: relative;
        ...
        <b:loop values='data:labels' var='label'>
          ...
          <b:widget id='Label4' locked='false' title='Tags' type='Label' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='selectedLabelsList'>ITEL,Mars,Micromax,Samsung,Symphony,Walton,Xiaomi</b:widget-setting>
    ...
    <data:messages.viewMyCompleteProfile/>
          ...
          <b:widget id='LinkList210' locked='false' title='Menu' type='LinkList' version='1'>
            <b:widget-settings>
              ...
              <b:widget-setting name='link-12'>http://www.templatesyard.com/2017/09/faster-fast-loading-blogger-template.html</b:widget-setting>
              <b:widget-setting name='link-0'>#</b:widget-setting>
              <b:widget-setting name='link-11'>https://youtu.be/x8Fgqi-gek8</b:widget-setting>
              <b:widget-setting name='link-10'>http://www.sorabloggingtips.com/2017/09/how-to-setup-faster-blogger-template.html</b:widget-setting>
              ...
              <b:widget-setting name='link-7'>https://faster-templatesyard.blogspot.com/templatesyard</b:widget-setting>
              <b:widget-setting name='link-8'>https://www.youtube.com/channel/UCCDjoOPSNiuLJX06HirPjOA?sub_confirmation=1</b:widget-setting>
              <b:widget-setting name='link-5'>http://faster-templatesyard.blogspot.com/p/post-format-and-page-markup.html</b:widget-setting>
   ...
   (adsbygoogle = window.adsbygoogle || []).push({});
          ...
          <b:widget id='LinkList236' locked='false' title='Social Media Icons' type='LinkList' version='1'>
            <b:widget-settings>
              ...
              <b:widget-setting name='text-6'>pinterest</b:widget-setting>
              <b:widget-setting name='sorting'>NONE</b:widget-setting>
              <b:widget-setting name='link-1'>#</b:widget-setting>
              <b:widget-setting name='link-2'>#</b:widget-setting>
              <b:widget-setting name='link-0'>#</b:widget-setting>
          ...
          <b:widget id='Image1' locked='false' title='About Us' type='Image' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/a/AVvXsEjOkFqrNCJvuDjSTNYOj53_G4-K5xqHXo890SsGrHJjLIhIccl2ypiW1_d6Ra7KfvJevMISB2PmFqlo5E01Y9oxPxRms72RI4XF2w6FeGfSSjGLT-IKSibKzQ71HaGtdCnUP189Zed2RzsIHETBlgTrS3nvB-YBbXaRpYmXOF1ugzr-pro4DC4BHhxq=s457</b:widget-setting>
              <b:widget-setting name='displayHeight'>457</b:widget-setting>
              <b:widget-setting name='sectionWidth'>257</b:widget-setting>
              ...
              <b:widget-setting name='caption'>Technical Arif BD (ALL Mobile Flash software free) Rangpur.BANGLADESH ?  এখ&#2494;ন&#2503; সব ম&#2507;ব&#2494;ইল ফ&#2509;ল&#2509;য&#2494;শ ফ&#2494;ইল ফ&#2509;র&#2495; ত&#2503; প&#2494;ব&#2503;ন ?   Whatsapp/imo  +8801788106492</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
    ...
    <b:if cond='data:caption'>
      <span class='caption'><data:caption/></span>
          ...
          <b:widget cond='!data:view.isPost' id='PageList1' locked='false' title='' type='PageList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='pageListJson'><![CDATA[{"link0":{"href":"http://technicalarifbd.blogspot.com/","position":0,"title":"Home"}}]]></b:widget-setting>
...
&lt;/style&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML3' locked='false' title='' type='HTML' version='2' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'>&lt;a href=&quot;https://www.presearch.org/signup?rid=3725007&quot; target=&quot;_blank&quot;&gt;
...
&lt;/a&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML5' locked='false' title='Subscribe Us' type='HTML' version='2' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'>&lt;div class=&quot;youtube-player&quot; data-id=&quot;ruQsRfHFU5g&quot; /&gt;
&lt;style&gt;
.youtube-player {
  position: relative;
  padding-bottom: 56.25%;
...
&lt;/script&gt;&lt;/div&gt;</b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML2' locked='false' title='Technical Arif BD' type='HTML' version='2' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'>&lt;div class=&quot;cleanslate w24tz-current-time w24tz-middle&quot; style=&quot;display: inline-block !important; visibility: hidden !important; min-width:300px !important; min-height:145px !important;&quot;&gt;&lt;p&gt;&lt;a href=&quot;//24timezones.com/time-zone/bst_bangladesh&quot; style=&quot;text-decoration: none&quot; class=&quot;clock24&quot; id=&quot;tz24-1644840993-tzbst_bangladesh-eyJob3VydHlwZSI6MTIsInNob3dkYXRlIjoiMSIsInNob3dzZWNvbmRzIjoiMSIsImNvbnRhaW5lcl9pZCI6ImNsb2NrX2Jsb2NrX2NiNjIwYTQ4MjFkYjdlMCIsInR5cGUiOiJkYiIsImxhbmciOiJlbiJ9&quot; title=&quot;Clock - BST&quot; target=&quot;_blank&quot; rel=&quot;nofollow&quot;&gt;&lt;/a&gt;&lt;/p&gt;&lt;div id=&quot;clock_block_cb620a4821db7e0&quot;&gt;&lt;/div&gt;&lt;/div&gt;
&lt;script type=&quot;text/javascript&quot; src=&quot;//w.24timezones.com/l.js&quot; async&gt;&lt;/script&gt;</b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
  ...
  <div class='container row'>
    <b:section class='footer-menu' id='footer-menu' maxwidgets='1' name='Footer Menu' showaddelement='yes'>
      <b:widget id='LinkList76' locked='true' title='Footer Menu Widget' type='LinkList' version='2' visible='true'>
        <b:widget-settings>
          <b:widget-setting name='link-3'>https://technicalarifbd.blogspot.com/p/privacy_6.html</b:widget-setting>
          <b:widget-setting name='sorting'>NONE</b:widget-setting>
          <b:widget-setting name='text-1'>About</b:widget-setting>
          <b:widget-setting name='link-1'>https://technicalarifbd.blogspot.com/p/about-us.html</b:widget-setting>
          <b:widget-setting name='text-0'>Home</b:widget-setting>
          <b:widget-setting name='link-2'>https://technicalarifbd.blogspot.com/p/contact-us.html</b:widget-setting>
